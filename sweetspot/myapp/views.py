    ...
    def create(self, request,pk=None):
        ...
        try:
            ...
            if cart_item:
                ...
                cart_item.total_amount = cake.price * quantity
                if customization_id:
                ...
                cart = Cart.objects.create(customer=customer, quantity=quantity, total_amount=cake.price * quantity)
                cart.cake.add(cake)
                if customization_id:
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def partial_update(self, request, pk=None):
        ...
        my_mail="ayushtiwari3542@gmail.com"
        ...
        from_email = 'ayushtiwari3542@gmail.com'  # Your Gmail email address
    ...
    def delivery_tracking(self,request,id):
        ...
        try:
            ...
            sweetspot_location="Deepu chauhan, Kanpur , Uttar Pradesh , India"
