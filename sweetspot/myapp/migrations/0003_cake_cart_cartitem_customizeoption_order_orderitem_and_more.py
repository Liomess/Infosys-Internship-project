# Generated by Django 4.2.9 on 2024-04-20 10:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0002_alter_customer_email_alter_customer_mobile'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('cake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.cake')),
                ('customization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.customizeoption')),
        ...
        migrations.AddField(
            model_name='cartitem',
            name='customization',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.customizeoption'),
        ),
        migrations.AddField(
            model_name='cart',
            name='cart',
