...
class Customer(models.Model):
    ...
    username = models.CharField(max_length=150, unique=True, null=True)  # Allow null values
...
class Cake(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2)  # DecimalField for price
    description = models.TextField()
...
class Cart(models.Model):
    ...
    quantity = models.PositiveIntegerField(default=1)  # PositiveIntegerField for quantity
    customization = models.ForeignKey(CakeCustomization, on_delete=models.CASCADE, null=True, default=None)
    total_amount = models.DecimalField(max_digits=20, decimal_places=2, default=0)  # DecimalField for total_amount
